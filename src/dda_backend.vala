...
namespace Dda
{
  ...
  public abstract class Backend : GLib.Object
  {
    ...
    public abstract uint get_n_device();
    public abstract Dda.InputStream read(BackendParameters parameters, double sample_rate, uint frame_per_call, Dda.BackendFlags flags);
    public abstract Dda.OutputStream write(BackendParameters parameters, double sample_rate, uint frame_per_call, Dda.BackendFlags flags);
  }
  ...
  {
    private weak Dda.Backend backend;
    private uint index;
